 ...
 * ════════════════════════════════════════════════════════════════════════════════════
 * 
 * Этот файл содержит примеры CMake конфигураций для C++20/23.
 * Весь код представлен в комментариях с подробными объяснениями.
 * 
 * ОСНОВНЫЕ ТЕМЫ:
 * 
 * 1️⃣  Modern CMake - target-based подход (вместо глобальных команд)
 * 2️⃣  Структура проекта и организация файлов
 * 3️⃣  C++20/23 поддержка (модули, концепты, ranges)
 * 4️⃣  Управление зависимостями (find_package, FetchContent)
 * 5️⃣  Compiler warnings и sanitizers (безопасность)
 * 6️⃣  Тестирование с CTest и GoogleTest
 * 7️⃣  Оптимизации компилятора и LTO
 * 8️⃣  CMakePresets.json (современная конфигурация)
 * 9️⃣  Установка и создание пакетов (install, CPack)
 * 🔟 Полезные трюки и best practices
 * 
 * 📌 Требования: CMake 3.20+
 * 📌 Компиляция: Этот файл - справочник, не компилируется
 */
