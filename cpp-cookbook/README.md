# Коллекция полезных приёмов и шаблонов (C++20/23)
...
* 📌  **Генерация последовательных значений (`std::iota`, `std::ranges::iota_view`)**
* 📌  **Удаление элементов по условию (`std::remove_if`, `std::erase_if` C++20)**
* 📌  **Произвольное накопление (`std::accumulate`, `std::ranges::fold` C++23)**
* 📌  **Заполнение массива значением (`std::fill`, `std::ranges::fill`)**
* 📌  **Подсчёт вхождений элемента (`std::count`, `std::ranges::count`)**
* 📌  **Сумма элементов с условием**
* 📌  **Zip двух массивов (`std::transform`, `std::views::zip` C++23)**
* 📌  **Многомерные массивы (`std::mdspan` C++23)**

***

### 🔄 [Работа с Ranges (C++20/23)](./ranges.cpp)

* 📌  **Views: `filter`, `transform`, `take`, `drop`**
* 📌  **Zip views (`std::views::zip`, `std::views::zip_transform` C++23)**
* 📌  **Chunk views (`std::views::chunk`, `std::views::slide` C++23)**
* 📌  **Cartesian product (`std::views::cartesian_product` C++23)**
* 📌  **Enumerate (`std::views::enumerate` C++23)**
* 📌  **Join with (`std::views::join_with` C++23)**
* 📌  **Fold операции (`std::ranges::fold_left`, `fold_right` C++23)**
* 📌  **Адаптеры и композиция views**
...
* 📌  **Плоские контейнеры (`std::flat_map`, `std::flat_set` C++23)**
* 📌  **Добавление / удаление элементов**
* 📌  **Проверка наличия элемента / ключа (`contains()` C++20)**
* 📌  **Итерирование по `std::set` / `std::map`**
* 📌  **Счётчик частот (`std::unordered_map`) и сортировка по значению**
* 📌  **Объединение / пересечение / разность множеств (`std::set`, `std::ranges`)**

***

### 🗄️ [Работа со структурами и объектами](./objects.cpp)

* 📌  **Создание структуры и доступ к полям**
* 📌  **Деструктуризация (структурированные привязки C++17)**
* 📌  **Deducing this (явный объектный параметр C++23)**
...
### 🏗️ [Работа с классами и наследованием](./classes.cpp)

* 📌  **Базовое определение класса (конструктор, деструктор, методы)**
* 📌  **Конструктор копирования и оператор присваивания**
* 📌  **Конструктор перемещения и move-семантика**
* 📌  **Правило пяти (Rule of Five)**
* 📌  **Правило нуля (Rule of Zero) с умными указателями**
* 📌  **Базовое наследование (`public`, `protected`, `private`)**
* 📌  **Виртуальные функции и полиморфизм**
* 📌  **Абстрактные классы и чисто виртуальные функции**
* 📌  **Множественное наследование**
* 📌  **Виртуальное наследование (diamond problem)**
* 📌  **Перегрузка операторов (`+`, `+=`, `==`, `<<`, `[]`, `()`)**
* 📌  **Перегрузка инкремента/декремента (`++`, `--`)**
* 📌  **Операторы приведения типа (`operator int()`, `explicit`)**
* 📌  **Статические члены класса и методы**
* 📌  **Константные методы и `mutable`**
* 📌  **Friend функции и классы**
* 📌  **Вложенные классы**
* 📌  **CRTP (Curiously Recurring Template Pattern)**
* 📌  **`final` и `override` спецификаторы**
* 📌  **Делегирующие конструкторы (C++11)**
* 📌  **Наследование конструкторов (`using Base::Base`)**
...
* 📌  **`if consteval` (проверка compile-time контекста C++23)**
...
* 📌  **Обработка ошибок (`std::expected` C++23)**
...
* 📌  **Stack trace (`std::stacktrace` C++23)**
* 📌  **Unreachable hint (`std::unreachable()` C++23)**
...
* 📌  **Форматирование вывода (`std::format` C++20)**
